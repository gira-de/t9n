...
- 🪄 Transforms these translation keys into something translation agencies can work with (xlsx 🤩).
...
1. Create a file called _./locale/meta.json_. This json describes the structure of the actual language files. Every possible translation key as well as an initial translation needs to be described here.
